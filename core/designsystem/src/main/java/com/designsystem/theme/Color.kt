...
val NeutralGrey04Grey = Color(0xFF808080)
val Neutral06LightGrey = Color(0xFFCACACA)
val Neutral07LightestGrey = Color(0xFFDEDEDE)
val Neutral08Whisper = Color(0xFFEAEAEA)
val ShimmerDarkGrey = Color(0xFF2A2A2A)
val ShimmerLighterGrey = Color(0xFF444444)
val ShimmerHighlight = Color(0xFFEAEAEA)